...
public class ResultClassFile extends JavaFile {
    ...
    //生成哪种返回格式 1为当前标准结果 0为argus结果.
    private static final Integer RESULT_TYPE = 1;
    ...
    public ResultClassFile(String fileDir, String mainPackage, String curPackage) {
        ...
        String resource = "";
        if (RESULT_TYPE == 1) {
            resource = "import com.fasterxml.jackson.databind.JsonNode;\r\n" +
